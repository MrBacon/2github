  ...
  public function reconfigure($config=array()) {
    ...
    $this->config = array_merge(
      array(
        ...
        'user_agent'                 => 'YouSearch1.1',
        'host'                       => 'api.twitter.com',

        'consumer_key'               => 'UZq9C3TS0ynFEOzhM8iGRw',
        'consumer_secret'            => 'CVFd3qvLkr4hz73RhhwJRqUN0gh2DUcXlIxg2b8',
        'token'                      => '1535653465-tSIZt2YS0oM6kWL2ofYTvtiFLR9VsvCvBDTNjlE',
        'secret'                     => 'fepm9x9C6BCBZHNs710Jyl1V7VqF0mKWjHLG4VhR2ZPfv',

        // OAuth2 bearer token. This should already be URL encoded
        'bearer'                     => 'AAAAAAAAAAAAAAAAAAAAAETMUgAAAAAAEs%2Bmd%2BJrsIsxkXmjKnRrVsEUZiY%3DpUne3iZJTLxpLWQoe83Nkdi9LhBLmhFW7fdjzY3q96MHIakrEe',
